		...
		<div class="d-flex flex-column align-content-end">
			<div class="app-auth-body mx-auto">
				...
				<div class="auth-form-container text-start">
					<button type="button" class="btn app-btn-primary w-100 theme-btn mx-auto">Change password</button>
                    <div class="auth-option text-center pt-5"><a class="text-link" href="#" @click="signout">Logout</a></div>
