...
namespace SSO.Infrastructure.Configs
{
    public class ApplicationUserConfig : IEntityTypeConfiguration<ApplicationUser>
    {
        ...
        public void Configure(EntityTypeBuilder<ApplicationUser> builder)
        {
            ...
            builder.Property(x => x.TwoFactorSecretKey).HasMaxLength(200).IsRequired(false);
        ...
        void UseSqlServer(EntityTypeBuilder<ApplicationUser> builder)
        {
            ...
            builder.HasIndex(x => x.TwoFactorSecretKey).IsUnique().HasDatabaseName("IX_TwoFactorSecretKey").HasFilter("[TwoFactorSecretKey] IS NOT NULL");
        }
        ...
        void UseMySql(EntityTypeBuilder<ApplicationUser> builder)
        {
            ...
            builder.HasIndex(x => x.TwoFactorSecretKey).IsUnique(); // Allows multiple nulls, as expected in MySQL
        }
        ...
        void UsePostgres(EntityTypeBuilder<ApplicationUser> builder)
        {
            ...
            builder.HasIndex(x => x.TwoFactorSecretKey).IsUnique().HasFilter("TwoFactorSecretKey IS NOT NULL"); // Filter for uniqueness on non-null values
        }
    }
}
